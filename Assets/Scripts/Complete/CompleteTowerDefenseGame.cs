...
public sealed class CompleteTowerDefenseGame : MonoBehaviour
{
    ...
    private void CreateCanvas()
    {
        ...
        menuStartButton = CreateButton("StartButton", menuPanel.transform, "", new Vector2(0f, 125f), StartNewGame, menuButtonSize);
        ApplyButtonSprite(menuStartButton, startButtonSprite, true);
        menuSoundButton = CreateButton("SoundButton", menuPanel.transform, "", new Vector2(0f, -35f), ToggleSound, menuButtonSize);
        ApplyButtonSprite(menuSoundButton, soundOn ? soundOnSprite : soundOffSprite, true);
        menuExitButton = CreateButton("ExitButton", menuPanel.transform, "", new Vector2(0f, -205f), ExitGame, menuButtonSize);
    ...
    private void SpawnEnemy(EnemyConfig config)
    {
        ...
        enemy.transform.position = pathPoints[0];
